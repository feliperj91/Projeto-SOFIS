                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; align-items: end;">
                    ...
                    <div class="credential-field-item">
                         <div class="credential-label-row" style="height: 24px; display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px;">
                            ...
                            <button type="button" class="btn-remove-credential-icon" onclick="removeVpnCredentialField(this)" title="Remover Credencial" tabindex="-1" style="background: none; border: none; color: var(--text-secondary); cursor: pointer; opacity: 0.7; transition: opacity 0.2s; padding: 0; display: flex; align-items: center;">
                                <i class="fa-solid fa-trash-can" style="font-size: 0.95rem;"></i>
                            </button>
                        </div>
                        <div style="position: relative; width: 100%;">
            ...
            <div class="credential-fields-layout" style="display: flex; flex-direction: column; gap: 15px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; align-items: end;">
                    <div class="credential-field-item">
                         <div style="height: 24px; display: flex; align-items: center; margin-bottom: 5px;">
                            <label class="credential-label-text" style="margin: 0; display: flex; align-items: center;">
                                <i class="fa-solid fa-user" style="color: var(--accent); margin-right: 6px; font-size: 0.9rem;"></i> Usuário
                            </label>
                        </div>
                    ...
                    <div class="credential-field-item">
                        <div class="credential-label-row" style="height: 24px; display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px;">
                            <label class="credential-label-text" style="display: flex; align-items: center; margin: 0;">
                                <i class="fa-solid fa-key" style="color: var(--accent); margin-right: 6px; font-size: 0.9rem;"></i> Senha
                            </label>
                            <button type="button" class="btn-remove-credential-icon" onclick="removeUrlCredentialField(this)" title="Remover Credencial" tabindex="-1" style="background: none; border: none; color: var(--text-secondary); cursor: pointer; opacity: 0.7; transition: opacity 0.2s; padding: 0; display: flex; align-items: center;">
                                <i class="fa-solid fa-trash-can" style="font-size: 0.95rem;"></i>
                            </button>
                        </div>
                        <div style="position: relative; width: 100%;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; align-items: end;">
                    ...
                    <div class="credential-field-item">
                       <div class="credential-label-row" style="height: 24px; display: flex; justify-content: space-between; align-items: center; margin-bottom: 5px;">
                            ...
                            <button type="button" class="btn-remove-credential-icon" onclick="removeHostCredentialField(this)" title="Remover Credencial" tabindex="-1" style="background: none; border: none; color: var(--text-secondary); cursor: pointer; opacity: 0.7; transition: opacity 0.2s; padding: 0; display: flex; align-items: center;">
                                <i class="fa-solid fa-trash-can" style="font-size: 0.95rem;"></i>
                            </button>
                        </div>
                        <div style="position: relative; width: 100%;">
